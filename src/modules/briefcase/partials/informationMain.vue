<template>
    ...
    <section
        ...
        ref="jobSection"
    >
        <div class="flex flex-row gap-3 lg:flex-col lg:w-[20%]">
            <button
        ...
        <article>
            <h3>Ingerio Electromecanico <span>@Felipe</span></h3>
            <h4>Yave Felipe Barrera Pico</h4>
        </article>
    </section>
</template>
